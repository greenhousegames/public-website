...
var _reporting = require('@greenhousegames/game-template/dist/reporting');
...
require.register("reporting/game-template.js", function(exports, require, module) {
'use strict';
...
var Reporting = function (_FirebaseClient) {
  ...
  function Reporting() {
    ...
    _this.reporting = new _reporting2.default(_this.firebase.database().ref('games/game-template/data'), _this.firebase.database().ref('games/game-template/reporting'));
    return _this;
  }
  ...
  _createClass(Reporting, [{
    ...
    value: function _draw() {
      ...
      _rsvp2.default.all([aClickedQuery, bClickedQuery]).then(function (values) {
        var element = jQuery('#pie_chart_div');
        var data = new google.visualization.arrayToDataTable([['Button', 'Times Clicked'], ['A', values[0]], ['B', values[1]]]);
      ...
      _rsvp2.default.all([aClickedThisHourQuery, bClickedThisHourQuery]).then(function (values) {
      ...
      _rsvp2.default.all([aClickedTodayQuery, bClickedTodayQuery]).then(function (values) {
      ...
      _rsvp2.default.all([aClickedMonthQuery, bClickedMonthQuery]).then(function (values) {
      ...
      _rsvp2.default.all([aClickedYearQuery, bClickedYearQuery]).then(function (values) {
